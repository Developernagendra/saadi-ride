...
const VendorFAQ = () => {
  ...
  const faqs = [
    {
      question: "How do I join WedMeGood as a vendor?",
      answer: "To join WedMeGood as a vendor, you can click on the 'Join as Vendor' button on our website. Fill out the required information, upload your portfolio, and our team will review your application. Once approved, you'll receive a confirmation email with your account details."
    },
    {
      question: "What types of vendors can join WedMeGood?",
      answer: "WedMeGood welcomes a wide range of wedding vendors including photographers, makeup artists, wedding planners, venues, caterers, decorators, bridal wear designers, groom wear designers, invitation designers, choreographers, mehendi artists, and more."
    },
    {
    ...
    {
      question: "How do I get more leads through WedMeGood?",
      answer: "To maximize your leads on WedMeGood, we recommend completing your profile with high-quality photos, detailed descriptions, and accurate pricing information. Respond promptly to inquiries, collect reviews from past clients, and consider upgrading to a premium listing for better visibility and additional features."
    },
    {
    ...
    {
      question: "How do customers contact me through WedMeGood?",
    ...
    {
      question: "How do I get featured on WedMeGood's homepage or blog?",
    ...
    {
      question: "What support does WedMeGood provide to vendors?",
    ...
    {
      question: "Can I advertise my business on WedMeGood?",
      ...
      <main className="flex-grow pt-24 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Find answers to common questions about joining and growing your business with WedMeGood
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-wedding-cream/50 p-6 rounded-lg border">
              ...
              <p className="text-gray-600 mb-6">
                Our vendor support team is here to help you with any questions about joining WedMeGood or managing your vendor profile.
              </p>
              <Button 
                variant="outline" 
                className="border-wedding-pink text-wedding-pink hover:bg-wedding-pink/10"
