          ...
          {footerLinks.map((column) => (
            <div key={column.title} className="footer-column">
              <div className="flex items-center gap-2 mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold">{column.title}</h3>
              </div>
              {column.description && <p className="text-gray-300 text-xs sm:text-sm mb-3 sm:mb-4">{column.description}</p>}
              <ul className="space-y-1 sm:space-y-2">
                {column.links.map((link) => (
                  <li key={link.name}>
                    <Link 
                      to={link.url} 
                      className="flex items-center gap-1 sm:gap-2 text-gray-300 hover:text-wedding-pink transition-colors group text-xs sm:text-sm"
        ...
        <div className="border-t border-gray-800 pt-4 sm:pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            ...
            <div className="flex flex-wrap justify-center md:justify-end space-x-4 sm:space-x-6">
              <Link to="/about/terms-privacy" className="text-gray-400 hover:text-wedding-pink text-xs sm:text-sm">
                Privacy Policy
              </Link>
              <Link to="/about/terms-privacy" className="text-gray-400 hover:text-wedding-pink text-xs sm:text-sm">
                Terms of Service
